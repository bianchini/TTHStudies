...
process.fwliteInput = cms.PSet(
    ...
    histoName = cms.string("VType0_leadMuPt"),
    ...
    yTitle    = cms.string("Events"),
    histoName = cms.string("VType0_trailMuPt"),
    cut       = cms.string(common),
    logy      = cms.int32(0),
    ),
    ...
    yTitle    = cms.string("Events"),
    histoName = cms.string("VType0_vertex"),
    cut       = cms.string(common),
    logy      = cms.int32(0),
    ),
    ...
    yTitle    = cms.string("Events"),
    histoName = cms.string("VType0_met"),
    cut       = cms.string(common),
    logy      = cms.int32(0),
    ),
    ...
    yTitle    = cms.string("Events"),
    histoName = cms.string("VType0_leadMuEta"),
    cut       = cms.string(common),
    logy      = cms.int32(0),
    ),
    ...
    yTitle    = cms.string("Events"),
    histoName = cms.string("VType0_trailMuEta"),
    cut       = cms.string(common),
    logy      = cms.int32(0),
    ),
