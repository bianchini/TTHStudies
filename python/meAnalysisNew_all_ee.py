...
process.fwliteInput = cms.PSet(
    ...
    cms.PSet(
    skip     = cms.bool(True),
    name     = cms.string('DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph'+VType),
    ...
    cms.PSet(
    skip     = cms.bool(True),
    name     = cms.string('TTJets_HadronicMGDecays_8TeV-madgraph'+VType),
    ...
    cms.PSet(
    skip     = cms.bool(True), 
    name     = cms.string('DoubleElectronRun2012CAug24Rereco'+VType),
    nickName = cms.string('Run2012_DoubleElectronRun2012CAug24Rereco'),
    color    = cms.int32(1),
    xSec     = cms.double(-1),
    ),
    cms.PSet(
    ...
    name     = cms.string('SingleMuRun2012AAug06'+VType),
    ...
    name     = cms.string('SingleMuRun2012AJul13'+VType),
    ...
    name     = cms.string('SingleMuRun2012BJul13'+VType),
    ...
    cms.PSet(
    skip     = cms.bool(True), 
    name     = cms.string('SingleMuRun2012CAug24Rereco'+VType),
    ...
    cms.PSet(
    skip     = cms.bool(True), 
    name     = cms.string('SingleMuRun2012CPromptV2TopUp'+VType),
    ...
    cms.PSet(
    skip     = cms.bool(True), 
    name     = cms.string('SingleMuRun2012CPromptv2'+VType),
